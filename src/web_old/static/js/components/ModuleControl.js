...
window.ModuleControl = {
    ...
    setup() {
        ...
        // ====================================================================
        // GETSTATUSCLASS - ITT DEFINÍLJUK LOKÁLISAN!
        // ====================================================================
        ...
        const formatStatus = (status) => {
            const translations = {
                ...
                'watching': t('modules.status_watching'),
        ...
        const controlModule = async (module, action) => {
            ...
            try {
                ...
                alert(t('modules.control_error', { error: error.message }));
            } finally {
        ...
        return {
            ...
            // ITT ADJUK VISSZA A GETSTATUSCLASS-T!
            getStatusClass,
